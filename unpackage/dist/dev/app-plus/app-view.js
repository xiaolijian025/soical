...
Z([3,'content'])
Z([3,'iconfont icon-QQ'])
Z([3,'animated faster'])
Z([3,'swing'])
Z([3,'height:80rpx;width:300rpx;background-color:#007AFF;margin-top:30rpx;'])
Z([3,'点击效果'])
...
var x=['./pages/index/index.wxml','./pages/msg/msg.wxml','./pages/my/my.wxml','./pages/news/news.wxml'];d_[x[0]]={}
...
_(oB,xC)
var oD=_mz(z,'view',['class',2,'hoverClass',1,'style',2],[],e,s,gg)
